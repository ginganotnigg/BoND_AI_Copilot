...
class ConfluenceScreen extends StatelessWidget {
  ...
  ConfluenceScreen({super.key, required this.knowledge});

  final GlobalKey<FormState> formKey = GlobalKey<FormState>();
  final TextEditingController nameController = TextEditingController();
  final TextEditingController wikiPageUrlController = TextEditingController();
  final TextEditingController confluenceUsernameController =
      TextEditingController();
  final TextEditingController confluenceAccessTokenController =
      TextEditingController();
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            Image.asset(confluenceImagePath,
                                width: 50, height: 50),
